...
<div style="background:#7f1d1d;color:#fff;padding:.85rem 1.5rem;font-size:.9rem;
            line-height:1.45;border-bottom:3px solid #450a0a;">
  <strong>&#9888; Research use only.</strong>
  This report is generated by an automated pipeline and includes text produced by a
  large language model. It has <strong>not</strong> been validated for in&nbsp;vitro
  diagnostic (IVD) use and must not be used on its own for clinical decisions,
  treatment selection or patient management. Confirm every finding with a validated
  method before acting on it.
  <br>
  <span style="opacity:.85;">
    <strong>Yalnizca arastirma amaclidir.</strong> Bu rapor otomatik bir is akisi
    tarafindan uretilmistir ve buyuk dil modeli ciktisi icerir. In&nbsp;vitro tani
    (IVD) icin dogrulanmamistir; tek basina klinik karar, tedavi secimi veya hasta
    yonetimi icin kullanilamaz.
  </span>
</div>
